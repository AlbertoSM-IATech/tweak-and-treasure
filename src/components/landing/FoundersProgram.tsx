...
const FoundersProgram = () => {
  ...
  const stats = [
    { number: "17", label: "plazas ocupadas", icon: Users },
    { number: "3", label: "plazas disponibles", icon: Zap },
  ];
    ...
    <section id="founders" className="py-20 bg-gradient-to-b from-card/50 to-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <Badge 
            variant="outline" 
            className="mb-4 px-4 py-2 border-primary/50 bg-primary/10 text-primary font-medium"
          >
          ...
          <CardContent className="p-0">
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 bg-primary/5 border-r border-border">
                <div className="mb-6">
                  <span className="text-sm text-muted-foreground line-through">€588/año</span>
