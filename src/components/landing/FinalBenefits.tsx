...
const FinalBenefits = () => {
  const benefits = [
    "Acceso de por vida al plan Plus por ser fundador",
    "Todas las actualizaciones incluidas",
    "Acceso a nuevas funciones incluidas",
    "Participación en mejoras del producto",
    "Badge exclusivo de Fundador",
    "Sesión de onboarding 1:1 (opcional)"
  ];
        ...
        <AnimatedSection delay={0.2}>
          <Card className="max-w-2xl mx-auto bg-card border-primary/30">
            <CardContent className="p-8">
              ...
              <Button 
                size="lg" 
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-lg py-6 glow-primary"
