...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Puedes escribirnos directamente a hola@publify.app o a través de nuestras redes sociales. Los fundadores también tendrán acceso a un canal directo de comunicación con el equipo.",
    },
  ];
