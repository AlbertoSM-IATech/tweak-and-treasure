    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right Column - Dashboard Preview with Badges */}
          <motion.div
          ...
          >
            ...
            <div className="relative rounded-xl overflow-visible border border-border shadow-2xl glow-primary">
              ...
              {/* Before Badge */}
              <motion.div
                className="absolute -left-6 md:-left-8 top-4 md:top-8 bg-card/95 backdrop-blur-sm border border-destructive/50 rounded-2xl px-5 py-4 shadow-xl z-10"
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-red-400">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-white">Archivos dispersos</p>
              ...
              {/* After Badge */}
              <motion.div
                className="absolute -right-6 md:-right-8 bottom-4 md:bottom-8 bg-card/95 backdrop-blur-sm border border-primary/50 rounded-2xl px-5 py-4 shadow-xl z-10"
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0, y: [0, -8, 0] }}
                transition={{
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-white">Todo en un panel</p>
