    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <Badge 
            variant="outline" 
            className="mb-6 px-4 py-2 border-primary/50 bg-primary/10 text-primary font-medium animate-fade-in"
          >
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
            La plataforma todo-en-uno diseñada específicamente para Publishers de Amazon KDP. 
            Gestiona tu catálogo, analiza el mercado y escala tu negocio editorial.
          </p>
        ...
        <div className="relative max-w-5xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
          ...
          <div className="absolute -right-4 md:-right-8 top-1/3 bg-card border border-border rounded-lg p-4 shadow-xl animate-float hidden lg:block" style={{ animationDelay: "0.5s" }}>
